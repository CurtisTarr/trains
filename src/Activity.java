...
// called theActivities// -addMovementTo(<Integer>) adds a train movement (destination) activity to the record
...
public class Activity {
    ...
    public String trackString() {
        String trackStateAsString =
                "    " + "    " + trainTrack[2] + trainTrack[3] + trainTrack[4] + "\n"
